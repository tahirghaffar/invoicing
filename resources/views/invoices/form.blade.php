...
<style>
    ...
    <form id="invoice-form">
        ...
        <div class="card">
            ...
            <label
                for="sandbox_scenario_id"
                class="form-label"
            >
                FBR Sandbox Scenario
            </label>

            <select
                name="sandbox_scenario_id"
                ...
                function () {
                    ...
                    */
                    ...
                    if (!invoiceId) {
                        ...
                        $('#invoice-errors')
                            .html(
                                'Please save the invoice before FBR validation.'
                            )
                            .show();
